...
namespace botLibrary
{
	public partial class Client : Form
	{
		...
		public Client(string Name, string Pass, string ip)
		{
			...
			model.Images[0] = botLibrary.Properties.Resources.Bush.GetThumbnailImage(23, 23, null, IntPtr.Zero);
			model.Images[1] = botLibrary.Properties.Resources.grass.GetThumbnailImage(23, 23, null, IntPtr.Zero);
			model.Images[2] = botLibrary.Properties.Resources.clear.GetThumbnailImage(25, 25, null, IntPtr.Zero);
			model.Images[3] = botLibrary.Properties.Resources.box.GetThumbnailImage(23, 23, null, IntPtr.Zero);
			model.Images[4] = botLibrary.Properties.Resources.strelka.GetThumbnailImage(16, 16, null, IntPtr.Zero);
			model.Images[5] = botLibrary.Properties.Resources.clear100.GetThumbnailImage(100, 100, null, IntPtr.Zero);
			model.Images[6] = botLibrary.Properties.Resources.thisPlayer.GetThumbnailImage(17, 17, null, IntPtr.Zero);
			model.Images[7] = botLibrary.Properties.Resources.notThisPlayer.GetThumbnailImage(17, 17, null, IntPtr.Zero);
			model.Images[8] = botLibrary.Properties.Resources.marker.GetThumbnailImage(23, 12, null, IntPtr.Zero);
			model.Images[9] = botLibrary.Properties.Resources.marker2.GetThumbnailImage(23, 12, null, IntPtr.Zero);
			model.Images[10] = botLibrary.Properties.Resources.tree2.GetThumbnailImage(32, 32, null, IntPtr.Zero);
			model.Images[11] = botLibrary.Properties.Resources.Grenade.GetThumbnailImage(23, 23, null, IntPtr.Zero);
			model.Images[12] = botLibrary.Properties.Resources.Pistol.GetThumbnailImage(23, 23, null, IntPtr.Zero);
